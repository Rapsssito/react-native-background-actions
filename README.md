...
| `foregroundServiceType` | [`<foregroundServiceType>`](#foregroundservicetype)   | **Android only**. Array of foreground service types to combine. Must match `android:foregroundServiceType` in `AndroidManifest.xml`. |
